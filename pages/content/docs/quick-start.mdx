...
<Callout title="Prerequisites" type="info">
    Complete [Installation](/installation) before starting this guide.
</Callout>
...
<Cards>
  <Card title="Handle API reference" href="/API/Handle" />
  <Card title="Create a Store" href="/create-a-new-store" />
  <Card title="Create a Context" href="/create-a-new-context" />
</Cards>